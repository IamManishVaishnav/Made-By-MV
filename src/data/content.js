...
export const skills = {
  design: {
    ...
    tag:    'UX & Visual',
    accent: 'blue',
    items:  ['Figma', 'Adobe Suite', 'User Research', 'Wireframing', 'Prototyping', 'Design Systems', 'Usability Testing', 'Accessibility'],
  },
  dev: {
    label:  'Dev',
    tag:    'Frontend & Backend',
    accent: 'cyan',
    items:  ['React.js', 'Next.js', 'TypeScript', 'JavaScript', 'Tailwind CSS', 'Node.js', 'Express.js', 'SQL'],
  },
  ai: {
    label:  'AI Workflow',
    tag:    'Tools I use daily',
    accent: 'amber',
    items:  ['Claude', 'Midjourney', 'v0', 'Cursor AI'],
  },
}
